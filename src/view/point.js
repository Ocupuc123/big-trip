  ...
  <div class="event">
    ...
    <div class="event__schedule">
      <p class="event__time">
        ...
        &mdash;
        <time class="event__end-time" datetime="${humanizeDate(dateTo, 'YYYY-MM-DDTHH:mm')}">${humanizeDate(dateTo)}</time>
      </p>
    ...
    ${createOffers(offers) ? `<h4 class="visually-hidden">Offers:</h4>
